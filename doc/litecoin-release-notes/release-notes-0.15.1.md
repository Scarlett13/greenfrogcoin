Greenfrogcoin Core version *0.15.1* is now available from:

  <https://download.greenfrogcoin.org/greenfrogcoin-0.15.1/>
...
A number of changes to the way Greenfrogcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 toadpoles per kB (0.00001 GFR). This is to prepare for dropping the minimum transaction fee to 0.1 toadpoles per kB (0.0001 GFR) in the next release.
