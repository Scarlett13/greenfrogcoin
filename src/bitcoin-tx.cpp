...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s greenfrogcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  greenfrogcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded greenfrogcoin transaction") + "\n" +
              "  greenfrogcoin-tx [options] -create [commands]   " + _("Create hex-encoded greenfrogcoin transaction") + "\n" +
              "\n";
